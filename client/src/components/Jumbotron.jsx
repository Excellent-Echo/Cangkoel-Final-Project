...
import mockupImageSrc from '../assets/petani-jumbotron.png'

import { ContentWithPaddingXl, Container as ContainerBase } from './misc/Layouts.jsx'
import { SectionHeading } from './misc/Headings.jsx'

const Container = tw(ContainerBase)`bg-crowde-100 pt-24`
