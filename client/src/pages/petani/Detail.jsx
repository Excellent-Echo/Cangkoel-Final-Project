				...
				<div className="bg-dark-gray w-full min-h-screen ">
					<div className="w-full max-w-6xl mx-auto px-4 py-8 flex justify-between md:flex-no-wrap flex-wrap">
						<div className="md:w-1/3 w-full">
							<header>
								<img src="https://i.ibb.co/fDB3tPT/Group-1.png" alt="Profile" className="ml-12" />
								<img
							...
							<section className="mt-16">
								<h3 className="uppercase text-white font-medium text-3xl">Career Objectives</h3>
								<div className="h-1 bg-green w-48 my-4"></div>
								<p className="text-white">
									I am a motivated team player and aspiring web developer with great design and
									branding knowledge. My ultimate goal is to grow my knowledge of the industry and use
									my conversational skills to help fast-paced startup design UI/UX charismas.
								</p>
							</section>

							<section className="mt-16">
								<h3 className="uppercase text-white font-medium text-3xl">Specializations</h3>
								<div className="h-1 bg-green w-48 my-4"></div>
								<ul className="text-white list-disc list-inside">
									...
									<li>
										Can develop high-performant front-end interfaces which interacts with backend
										API
									</li>
								</ul>
							</section>
							...
							<section className="mt-16">
								...
								<div className="text-white">
									...
									>
										<ion-icon name="logo-twitter" className="mr-2"></ion-icon> Twitter
									</a>
									<a
										href="mailto:hello@justaashir.com"
										className="hover:underline flex items-center mt-1"
									>
										<ion-icon name="mail" className="mr-2"></ion-icon> hello@justaashir.com
									</a>
									<a href="https://justaashir.com" className="hover:underline flex items-center mt-1">
										<ion-icon name="globe" className="mr-2"></ion-icon> www.justaashir.com
									</a>
								</div>
							</section>
						</div>
						<div className="md:w-2/4 w-full">
							<section className="mt-16 md:mt-0">
								<h3 className="uppercase text-white font-medium text-3xl">Work Summary</h3>

								<div className="h-1 bg-green w-48 my-4"></div>
								<PrimaryLink css={roundedHeaderButton && tw`rounded-full`} href="/formulir-pengajuan">
									Book Now
								</PrimaryLink>
								<div className="mt-8">
									...
									<ul className="text-white list-disc list-inside mt-4">
										...
										<li>
											{' '}
											Worked with an amazing remote-team from SIngapore in an agile environment.
										</li>
									</ul>
								</div>
								...
								<div className="mt-8">
									...
									<h5 className="text-xl text-green">
										<a href="https://justifyagency.com" className="hover:underline">
											Justify Agency
										</a>{' '}
										| <i>2020 - Present</i>
									</h5>
									<ul className="text-white list-disc list-inside mt-4">
										<li>
											{' '}
											Meeting with clients to discuss project requirements and workflow. (Includes
											Startups & Products){' '}
										</li>
										<li> Working with distributed network of freelancers </li>
										<li>
											{' '}
											Complete Branding & Design System (Email, Social Media, Website, Print){' '}
										</li>
									</ul>
								</div>
							</section>
							<section className="mt-16">
								...
								<div className="mt-8">
									...
									<p className="text-white">
										Proud member of the shopify community, and their partner program. Setting up
										Shopify stores and making custom themes from a long time.
									</p>
								</div>

								<div className="mt-8">
									<h4 className="font-medium text-green text-2xl">
										<a href="https://dev.to/justaashir" className="hover:underline">
											DEV Community
										</a>{' '}
							...
							<section className="mt-16">
								...
								<div className="mt-8">
									<h4 className="font-medium text-green text-2xl">
										<a href="https://tailwindcssuikit.com" className="hover:underline">
											Tailwind CSS Ui Kit
										</a>
									</h4>
									<p className="text-white mt-2">
										Building this, in my free time. Making modern design systems and kits possible
										with TailwindCSS
									</p>
								</div>
								...
								<div className="mt-8">
									<h4 className="font-medium text-green text-2xl">
										<a href="https://remoteworkjar.com" className="hover:underline">
											RemoteWorkJar
										</a>
									</h4>
									<p className="text-white mt-2">
										Remote Job Board, where the main focus is to manually screen every job posted
										and help candidates get high-quality remote-only job postings.
									</p>
								</div>
							</section>
						</div>
