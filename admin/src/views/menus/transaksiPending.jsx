    ...
    <Card>
      <CardBody>
        <div className="d-flex align-items-center">
          <div>
            <CardTitle>Daftar Transaksi Pending</CardTitle>
        ...
        <Table className="no-wrap v-middle" responsive>
          <thead>
            <tr className="border-0">
              ...
              <th className="border-0">Jumlah Transfer</th>
              <th className="border-0">Rekening Pengirim</th>
              <th className="border-0">Bukti Transfer</th>
            </tr>
          </thead>
          <tbody>
            <tr>
